...
class TweepyExample(object):
    ...
    def __init__(self):
        consumer_key = "B4foCJyXABXXXXXXXXXXDnNTSD"
        consumer_secret_key = "OkXsih9S6eJNBkXXXXXXXXXXXXXXXs70eGla8NkLJlNpPJS"
        access_token = "1923202261-DpXXXXXXXXXXXXXXXRQlRuCaMjHL9yz"
        access_token_secret = "uudkilJk3mKg4XXXXXXXXXXXXzlGEAXVRz8g3WSgC"
